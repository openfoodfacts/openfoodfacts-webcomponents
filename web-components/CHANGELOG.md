...
* align API types and upgrade Open Food Facts SDK ([#583](https://github.com/openfoodfacts/openfoodfacts-webcomponents/issues/583)) ([2b40858](https://github.com/openfoodfacts/openfoodfacts-webcomponents/commit/2b40858ab1039e58e1747f47732f3cf49760e33a))
...
- nutripatrol dark mode ([#568](https://github.com/openfoodfacts/openfoodfacts-webcomponents/issues/568)) ([77944ef](https://github.com/openfoodfacts/openfoodfacts-webcomponents/commit/77944efa99981a16ffb361b18588d9375a21ad0b))
- **product-card:** show spinner while image loads ([d6324a4](https://github.com/openfoodfacts/openfoodfacts-webcomponents/commit/d6324a43f7026c57c326f406b00e93d6b1e3a546))
...
- change placeholder-image style to enhance appearance in product-card ([abf3a59](https://github.com/openfoodfacts/openfoodfacts-webcomponents/commit/abf3a5969ddca4a1b0f9365da0e1f7f4cbb63072))
- clean up event listener lifecycles ([44bd979](https://github.com/openfoodfacts/openfoodfacts-webcomponents/commit/44bd979d39fb46975fc7f79950a8be1f4bd54aa8))
- correct configuration element tag map ([7a125d3](https://github.com/openfoodfacts/openfoodfacts-webcomponents/commit/7a125d372995252f40950792366efef0807556c3))
- correct the utm_medium typo in the mobile badge links ([#578](https://github.com/openfoodfacts/openfoodfacts-webcomponents/issues/578)) ([683fb1d](https://github.com/openfoodfacts/openfoodfacts-webcomponents/commit/683fb1d09015263e7e9830da11eb18ca8628203f))
...
- **deps:** bump marked from 18.0.5 to 18.0.11 in /web-components ([#608](https://github.com/openfoodfacts/openfoodfacts-webcomponents/issues/608)) ([777c312](https://github.com/openfoodfacts/openfoodfacts-webcomponents/commit/777c312726743a25b491fc481076d7136267fc71))
...
- **deps:** bump the interface-libraries group across 1 directory with 2 updates ([#600](https://github.com/openfoodfacts/openfoodfacts-webcomponents/issues/600)) ([8e314b9](https://github.com/openfoodfacts/openfoodfacts-webcomponents/commit/8e314b9c47f1381c14da98d7c6d35a87a8417b06))
...
- ensure we fail if translations are not replicated + replicate missing translations ([#595](https://github.com/openfoodfacts/openfoodfacts-webcomponents/issues/595)) ([53eb152](https://github.com/openfoodfacts/openfoodfacts-webcomponents/commit/53eb15281c3c54ac7017be023d1c7b4799926b05))
...
- prevent double slashes in image URLs from getImageUrl() ([#455](https://github.com/openfoodfacts/openfoodfacts-webcomponents/issues/455)) ([69a68d3](https://github.com/openfoodfacts/openfoodfacts-webcomponents/commit/69a68d3ba35b9da658942f82ba19c49d112ff621))
...
- resolve npm audit and remove unused deps ([f4f0cb0](https://github.com/openfoodfacts/openfoodfacts-webcomponents/commit/f4f0cb08de4748573759452639b8fa4e3cbda109))
...
- Revise Arabic translations for user properties ([8de191c](https://github.com/openfoodfacts/openfoodfacts-webcomponents/commit/8de191c889e166e8c92907e1baef6d408825bbeb))
