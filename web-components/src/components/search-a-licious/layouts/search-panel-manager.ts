...
export class SearchaliciousPanelManager extends EventRegistrationMixin(LitElement) {
  /**
  ...
  override connectedCallback() {
    ...
    this.addEventHandler(SearchaliciousEvents.CHANGE_CHART_SIDEBAR_STATE, (event: Event) => {
  ...
  override disconnectedCallback() {
    ...
    this.removeEventHandler(SearchaliciousEvents.CHANGE_CHART_SIDEBAR_STATE, (event: Event) => {
      this.chartSideBarState = (event as CustomEvent).detail.state
    })
  }
