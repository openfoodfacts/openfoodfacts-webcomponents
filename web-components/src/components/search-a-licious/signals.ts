 ...
 */
const _canResetSearch: Record<string, Signal> = {} as Record<string, Signal<boolean>>

/**
 * Signals to indicate if the search has changed.
 * It is store in object to be able to access it by search name.
 */
const _isSearchChanged: Record<string, Signal> = {} as Record<string, Signal<boolean>>
...
const _searchResultDetail: Record<string, Signal<SearchResultDetail>> = {} as Record<
  string,
 ...
 */
const _isSearchLoading: Record<string, Signal> = {} as Record<string, Signal<boolean>>
