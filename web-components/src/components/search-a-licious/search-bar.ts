...
export class SearchaliciousBar extends SuggestionSelectionMixin(
  ...
  get placeholder() {
    return this._placeholder ?? msg("Search...", { desc: "Search bar placeholder" })
  }
  ...
  override firstUpdated(changedProperties: PropertyValues<this>) {
    ...
    this.suggesters = [...this.querySelectorAll("searchalicious-taxonomy-suggest")]
  ...
  override disconnectedCallback() {
    ...
    this.removeEventHandler(SearchaliciousEvents.RESET_SEARCH, (event: Event) => {
      if (isTheSameSearchName(this.name, event)) {
        this.onReset()
      }
    })
