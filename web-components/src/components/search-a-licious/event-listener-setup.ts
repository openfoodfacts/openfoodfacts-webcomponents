...
export const EventRegistrationMixin = <T extends Constructor<Object>>(superClass: T) => {
  /**
  ...
  class EventRegistrationMixinClass extends superClass {
    ...
    addEventHandler(event: string, handler: EventListenerOrEventListenerObject) {
    ...
    removeEventHandler(event: string, handler: EventListenerOrEventListenerObject) {
  ...
  return EventRegistrationMixinClass as Constructor<EventRegistrationInterface> & T
}
