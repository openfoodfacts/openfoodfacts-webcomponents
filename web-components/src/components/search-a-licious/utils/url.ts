 ...
 * @param params
 */
export const setURLHistory = (url: string, params: Record<string, string | undefined>): string => {
...
export const setCurrentURLHistory = (params: Record<string, string | undefined>): string => {
