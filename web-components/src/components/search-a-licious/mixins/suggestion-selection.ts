 ...
 */
export interface SuggestionSelectionMixinInterface extends DebounceMixinInterface {
  inputName: string
...
export const SuggestionSelectionMixin = <T extends Constructor<LitElement>>(
  ...
  return SuggestionSelectionMixinClass as Constructor<SuggestionSelectionMixinInterface> & T
}
